...
GEN2_LONG_TUNING = {
  MazdaFlags.GEN2: Gen2LongitudinalParams(
    coast_coeffs = [0.0035201462, 4.8074427238, -0.0000356496, -0.1775109325, -35.4061891090],
    coast_intercept = -0.0864329702,
    
    gas_coeffs = [98.7939928556, -0.9270735516, 0.0786404319, 51.2220756086, 3.1924947087, -0.0295178387, 0.1983687983, -0.0039855014, -0.0000023546],
    gas_intercept = 1955.8845315539,
    
    brake_coeffs = [1.4137995800, 5.2543138630, -55.4426488353, 4.9900945981, -0.0711327307],
    brake_intercept = 1900.8068183494,
