...
GEN2_LONG_TUNING = {
  MazdaFlags.GEN2: Gen2LongitudinalParams(
    coast_coeffs = [0.0003323189, 0.2703679560, 0.0000357139, -0.0370672329, 27.6006361521],
    coast_intercept = -0.0417613798,
    
    gas_coeffs = [122.0385284906, -2.2875049453, 0.0702687775, 53.0265508227, 1.6436548699, -0.0364822994, 0.0044827624, 0.0003715189, -0.0000142884],
    gas_intercept = 1978.3336329275,
    
    brake_coeffs = [68.9096347524, 7.2187176711, -27.9680283649, 1.9923130394, -0.1148834681],
    brake_intercept = 1875.0936436845,
