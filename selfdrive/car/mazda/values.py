...
GEN2_LONG_TUNING = {
  MazdaFlags.GEN2: Gen2LongitudinalParams(
    coast_coeffs = [0.0007457576, -0.1645820067, -0.0000027449, -0.0293577542, 21.3189365801],
    coast_intercept = -0.0265590701,
    
    gas_coeffs = [139.2728297528, -2.1116434183, 0.0629889416, 48.1283391914, 1.2991507478, -0.0380834873, 0.0214389591, -0.0001001160, -0.0000102554],
    gas_intercept = 1983.0275112410,
    
    brake_coeffs = [83.8791902472, 7.3482963538, -21.2223392639, 1.6025580218, -0.1271639434],
    brake_intercept = 1881.5844396740,
