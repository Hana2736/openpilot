...
NON_LINEAR_TORQUE_PARAMS = {
 ...
 #CAR.MAZDA_3_2019: (15.38616, 0.71899, 0.15015, 0.37999), # this used to be good but now its not. idk why, tires?
 #CAR.MAZDA_3_2019: (14.68616, 0.71899, 0.15015, 0.37999), # better....
 #CAR.MAZDA_3_2019: (14.28616, 0.71899, 0.15015, 0.37999), better....
 #CAR.MAZDA_3_2019: (13.70, 0.71899, 0.15015, 0.37999),
  CAR.MAZDA_3_2019: (13.50, 0.71899, 0.15015, 0.37999), # i am so confused. what changed?
...
class CarInterface(CarInterfaceBase):
  ...
  def _get_params(ret, candidate, fingerprint, car_fw, experimental_long, docs, frogpilot_toggles):
    ...
    ret.wheelSpeedFactor = 2069 / 2033
