...
std::unordered_map<std::string, uint32_t> keys = {
    ...
    {"AggressiveFollowLow", PERSISTENT},
    {"AggressiveFollowMid", PERSISTENT},
    ...
    {"RelaxedFollowLow", PERSISTENT},
    {"RelaxedFollowMid", PERSISTENT},
    ...
    {"StandardFollowLow", PERSISTENT},
    {"StandardFollowMid", PERSISTENT},
    ...
    {"TrafficFollowHigh", PERSISTENT},
    {"TrafficFollowLow", PERSISTENT},
    {"TrafficFollowMid", PERSISTENT},
    ...
    {"NoMRCC", PERSISTENT},
    {"NoFSC", PERSISTENT},
    {"Mazda3TuneA", PERSISTENT},
    {"Mazda3TuneB", PERSISTENT},
    {"Mazda3TuneC", PERSISTENT},
    {"Mazda3TuneD", PERSISTENT},
    {"MazdaCX30TuneA", PERSISTENT},
    {"MazdaCX30TuneB", PERSISTENT},
    {"MazdaCX30TuneC", PERSISTENT},
    {"MazdaCX30TuneD", PERSISTENT},
    {"MazdaCX50TuneA", PERSISTENT},
    {"MazdaCX50TuneB", PERSISTENT},
    {"MazdaCX50TuneC", PERSISTENT},
    {"MazdaCX50TuneD", PERSISTENT},
    {"MazdaAutoTune", CLEAR_ON_MANAGER_START},
    {"MazdaAutoTuneApply", CLEAR_ON_MANAGER_START},
    ...
    {"LatDelayCollect", CLEAR_ON_MANAGER_START},
    {"LatDelayFit", CLEAR_ON_MANAGER_START},
    {"LatDelayApply", CLEAR_ON_MANAGER_START},
    {"LatDelayReset", CLEAR_ON_MANAGER_START},
    {"LatDelayStatus", CLEAR_ON_MANAGER_START},
    {"LatDelayPending", PERSISTENT},
    {"LatDelayTable", PERSISTENT},
    {"LongDelayFit", CLEAR_ON_MANAGER_START},
    {"LongDelayApply", CLEAR_ON_MANAGER_START},
    ...
    {"LongStaticFit", CLEAR_ON_MANAGER_START},
    {"LongStaticApply", CLEAR_ON_MANAGER_START},
    {"LongStaticReset", CLEAR_ON_MANAGER_START},
    {"LongStaticStatus", CLEAR_ON_MANAGER_START},
    {"LongStaticPending", PERSISTENT},
    {"LongStaticMapTable", PERSISTENT},
    {"LatOpenLoopCollect", CLEAR_ON_MANAGER_START},
    {"LatOpenLoopFit", CLEAR_ON_MANAGER_START},
    {"LatOpenLoopApply", CLEAR_ON_MANAGER_START},
    {"LatOpenLoopReset", CLEAR_ON_MANAGER_START},
    {"LatOpenLoopStatus", CLEAR_ON_MANAGER_START},
    {"LatOpenLoopPending", PERSISTENT},
    {"MazdaCollectAll", CLEAR_ON_MANAGER_START},
    {"MazdaFitAll", CLEAR_ON_MANAGER_START},
    {"MazdaTuneStackStatus", CLEAR_ON_MANAGER_START},
